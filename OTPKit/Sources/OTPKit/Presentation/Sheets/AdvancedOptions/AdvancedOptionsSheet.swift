...
private extension AdvancedOptionsSheet {
    ...
    var accessibilitySection: some View {
        Section {
            ...
            .accessibilityLabel(
                OTPLoc("advanced_options.wheelchair_accessible_label",
                       comment: "Accessibility label for wheelchair toggle")
            )
            .accessibilityHint(
                OTPLoc("advanced_options.wheelchair_toggle_hint",
                       comment: "Accessibility hint for wheelchair toggle")
            )
        } footer: {
            Text(
                OTPLoc("advanced_options.wheelchair_footer",
                       comment: "Footer text explaining wheelchair accessibility")
            )
        }
    }
    ...
    var walkingDistanceSection: some View {
        Section(OTPLoc("advanced_options.walking_distance_title", comment: "Walking distance section title")) {
            HStack {
                ...
                Picker(
                    OTPLoc("advanced_options.max_walking_distance",
                           comment: "Maximum walking distance picker label"),
                    selection: $tripPlannerVM.maxWalkingDistance
                ) {
                ...
                .accessibilityLabel(
                    OTPLoc("advanced_options.max_walking_distance",
                           comment: "Maximum walking distance accessibility label")
                )
    ...
    var cancelButton: some View {
        ...
        .accessibilityLabel(
            OTPLoc("advanced_options.cancel_accessibility",
                   comment: "Cancel button accessibility label")
        )
    }
